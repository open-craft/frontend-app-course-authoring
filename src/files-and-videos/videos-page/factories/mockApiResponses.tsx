  ...
  previous_uploads: [
    {
      ...
      client_video_id: 'mOckID1.mp4',
      created: '',
      course_video_image_url: '/video',
      transcripts: [],
      status: 'Imported',
      duration: 12333,
      download_link: 'http://mOckID1.mp4',
      file_size: 213456354,
    },
    {
      edx_video_id: 'mOckID5',
      client_video_id: 'mOckID5',
      created: '',
      course_video_image_url: 'http:/video',
      transcripts: ['en'],
      status: 'Failed',
      duration: 12,
      download_link: 'http://mOckID5.mp4',
    },
    {
      edx_video_id: 'mOckID3',
      client_video_id: 'mOckID3.mp4',
      created: '',
